# ==========================================================================
#  Resources: Cloud9 S3 / s3.tf (S3 Terraform)
# --------------------------------------------------------------------------
#  Description
# --------------------------------------------------------------------------
#    - Resources Tags
...
locals {
  s3_tags = {
    "Name"          = "${var.env[local.env]}" == "prod" ? "${var.bucket_name}" : "${var.bucket_name}-${var.env[local.env]}-cicd",
    "ResourceGroup" = "${var.environment[local.env]}-S3-CICD"
  }
}
