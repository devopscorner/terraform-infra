...
module "helm_addon" {
  ...
  set_values = [
    ...
    },
    {
      ...
      value = var.tracing_config.prometheus_metrics_port
    },
    {
  ...
  irsa_config = {
    ...
    irsa_iam_policies = [
      ...
      "arn:${data.aws_partition.current.partition}:iam::aws:policy/AWSOpsWorksCloudWatchLogs",
    ]
  }
