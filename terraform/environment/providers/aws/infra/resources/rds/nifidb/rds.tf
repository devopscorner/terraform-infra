# ==========================================================================
#  Resources: RDS nifidb / rds.tf (RDS Terraform)
# --------------------------------------------------------------------------
#  Description
# --------------------------------------------------------------------------
#    - VPC References
...
resource "aws_security_group" "rds_default" {
  name        = "devopscorner-sg-rds-nifidb-${var.env[local.env]}"
...
module "db" {
  ...
  identifier        = "nifidb-${var.env[local.env]}"
  ...
  # final_snapshot_identifier = "nifidb-${var.env[local.env]}"
