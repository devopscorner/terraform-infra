...
main() {
  login_ecr
  # docker_push 0987654321 alpine devopscorner/terraform-infra
  # docker_push 0987654321 ubuntu devopscorner/terraform-infra
  # docker_push 0987654321 codebuild devopscorner/terraform-infra
